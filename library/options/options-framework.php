    ...
    <div id="optionsframework-metabox" class="metabox-holder">
	    <div id="optionsframework" class="postbox">
			...
			<div id="optionsframework-submit">
				...
				<input type="submit" class="restore-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Default Options', 'optionsframework' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings you have specified in this panel will be lost!', 'options_framework_theme' ) ); ?>' );" />
				<input type="submit" class="reset-button button-secondary" name="resetmods" value="<?php esc_attr_e( 'Reset Theme Mods', 'optionsframework' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme mods you have set in the Theme Customizer will be lost!', 'options_framework_theme' ) ); ?>' );" />
				<div class="clear"></div>
			</div>
			</form>
		</div> <!-- / #container -->
