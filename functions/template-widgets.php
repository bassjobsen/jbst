...
class Skematik_Menu_Widget extends WP_Widget {
  ...
  function widget($args, $instance)
  {
		...
		wp_nav_menu( array( 'fallback_cb' => '', 'menu' => $nav_menu, 'link_before' => '<i class="icon-chevron-right"></i>', 'menu_class' => 'nav skematik_custom_nav '.$show_info.' nav-stacked', 'walker' => new description_walker()) );
